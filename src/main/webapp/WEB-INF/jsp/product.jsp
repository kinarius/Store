...
<body>
	...
	<div class="women-product">
		...
		<div class="pageNumber">
		       第${page.pageNum }页&nbsp;&nbsp;
<a href="${pageContext.request.contextPath}/go.action?pagenum=${page.pageNum-1>0?page.pageNum-1:1}">上一页</a>&nbsp;&nbsp;
<a href="${pageContext.request.contextPath}/go.action?pagenum=${page.pageNum+1}&kw=${page.kw}">下一页</a>
		       </div>
	</div>
	<div class="sub-cate">
